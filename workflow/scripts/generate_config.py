...
def make_config(insulations, sample, matrix, tads, loops,
                ctcfs, ctcf_orientation, genes, depth):

    print('[spacer]')
    if matrix and not_empty(matrix):
        write_matrix(sample, matrix, depth)
...
def write_matrix(sample, matrix, depth = 1000000):
